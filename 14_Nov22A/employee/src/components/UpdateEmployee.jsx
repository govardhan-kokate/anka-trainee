...
export default function UpdateEmployee(props) {
  ...
  const UserData = (user) => {
    axios
      .put(`http://localhost:3000/registration/${props.employeeData.id}`, req)
      .then((res) => {
        console.log(res);
        props.fetchAPI();
...
<div>
{setValue("firstname",props.employeeData.firstname)}
{setValue("lastname",props.employeeData.lastname)}
{setValue("dateofbirth",props.employeeData.dateofbirth)}
{setValue("gender",props.employeeData.gender)}
{setValue("selectstream",props.employeeData.selectstream)}
{setValue("skill",props.employeeData.skill)}
{setValue("bio",props.employeeData.bio)}
      ...
      <Box sx={style}>
        ...
        >
          ...
          Edit User: {props.employeeData.firstname}{" "}
